...
@Table(
        name = "todo_title_history",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_todo_title_history_member_title",
                        columnNames = {"member_id", "title"}
                )
        }
//        indexes = {
//                @Index(
//                        name = "idx_todo_title_history_member_last_used_at",
//                        columnList = "member_id, last_used_at"
//                )
//        }
)
public class TodoTitleHistory extends BaseEntity {
